...
public class SDCardUtils {
    ...
    /**
     * 获取sdcard可用空间的大小
     * @param unit (BYTE,KB,MB)
     * @return
     */
    @SuppressWarnings("deprecation")
    public static long getSDFreeSize(String unit) {
...
//		 context.getFilesDir().getAbsolutePath();
     ...
     * @return
     */
    public static String getAvailMemory(Activity contexts) {
        Context context = contexts.getBaseContext();

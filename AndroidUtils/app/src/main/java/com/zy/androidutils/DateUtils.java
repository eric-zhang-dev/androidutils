...
public class DateUtils {
    ...
    public static String toPattern(String dateString, String pattern) {
        ...
        Date date = null;
        if (pattern.equals(DATE) || pattern.equals(DATESTR)
                || pattern.equals(DATEMONTHCZ))
     ...
     * 根据指定格式返回当前日期时间
        DATE_NODAY = "yyyy-MM";
         DATE = "yyyy-MM-dd";
         DATEMONTHCZ = "yyyy年MM月";
         DATESTR = "yyyyMMdd";
        TIME = "HH:mm:ss";
        DATETIME = "yyyy-MM-dd HH:mm:ss";
        PRECISE = "yyyy-MM-dd HH.mm.ss.SSS";
         PRECISE = "yyyy-MM-dd$HH.mm.ss";
    ...
    public static String useTime(long startTime) {
        ...
        double between = (double) ((Calendar.getInstance()).getTimeInMillis() - startTime) / 1000;
        return "use：" + df.format(between) + "秒";
    }
    ...
    public static long getUTCTime() {
        ...
        int zoneOffset = mCalendar.get(java.util.Calendar.ZONE_OFFSET);
        int dstOffset = mCalendar.get(java.util.Calendar.DST_OFFSET);
    ...
    /**
     *
     * @Description: TODO(计算两个日期相差多少年月日)
     * @author zhangy
     * @date 2016年2月2日 上午9:36:42
     * @version V3.41
     */
    public static String calculateDays(String smdate, String bdate)
            throws ParseException {
        if (smdate.equals(bdate)) {
            return "0天";
        }
        int year1 = 0, year2 = 0, month1 = 0, month2 = 0, day1 = 0, day2 = 0, tempY = 0, tempM = 0, tempD = 0;
        String[] str1 = smdate.split("-");
        year1 = Integer.parseInt(str1[0]);
        month1 = Integer.parseInt(str1[1]);
        day1 = Integer.parseInt(str1[2]);

        String[] str2 = bdate.split("-");
        year2 = Integer.parseInt(str2[0]);
        month2 = Integer.parseInt(str2[1]);
        day2 = Integer.parseInt(str2[2]);
